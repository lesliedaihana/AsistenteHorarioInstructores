...
from asistenteHorarios.models import FichasCaracterizacion, ProgramasFormacion, Resultados
# Algoritmo
...
class sena15Pruebass:
    def __init__(self, id):
        self.id = id

    def Fichas(self):
        return FichasCaracterizacion.objects.get(id = self)

    def FichasFalla(self):
        return None
